...
function wp_nav_menu( $args = array() ) {
	...
	'echo' => true, 'fallback_cb' => 'wp_page_menu', 'before' => '', 'after' => humescores_get_svg(['icon'=>'angle-down']), 'link_before' => '', 'link_after' => '', 'items_wrap' => '<ul id="%1$s" class="%2$s">%3$s</ul>', 'item_spacing' => 'preserve',
